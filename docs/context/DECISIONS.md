...
- `D-20260426-011` | 2026-04-26 | 集計結果一覧は総合計料金の降順で固定し、クイック選択には年(1月〜12月) と 年度(6月〜5月) を追加する。円グラフ凡例には当年に加えて前年の数値とシェア率も表示する | `docs/spec_001_sales_destination_annual_csv.md` | active
